        ...
        <div ref={titleRef} className="container w-[90%] mx-auto py-14 flex flex-col gap-14 lg:flex-row lg:justify-between">
          ...
          <div className="mt-2 lg:mt-20 lg:w-[45%] text-center flex flex-col gap-3">
            ...
            <p className="text-base md:text-xl lg:text-base text-[#D1D5DB]">
              This was a project I did for a travel agency. I used HTML CSS to
            ...
            <div className="mt-5 w-[90%] md:w-[50%] lg:w-[60%] mx-auto flex items-center justify-center gap-5">
              <a
                href="https://travel-agency-project-peach.vercel.app/"
                target="_blank"
                className="myMenu3"
              >
                Live
              ...
              <a
                href="https://github.com/Mamunur-Roshid99/Travel-Agency-Project"
                target="_blank"
                className="myMenu3"
              >
                Code
